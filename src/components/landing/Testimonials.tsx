...
const items = [
  { name: "Beatriz M.", text: "Giovanna transformou meu olhar! Saí me sentindo a versão mais bonita de mim. Atendimento impecável." },
  { name: "Camila R.", text: "Profissional sensacional, ambiente lindo e resultado natural perfeito. Indico de olhos fechados." },
  { name: "Larissa P.", text: "Cada detalhe foi pensado com carinho. Minhas sobrancelhas nunca estiveram tão bem desenhadas." },
];
